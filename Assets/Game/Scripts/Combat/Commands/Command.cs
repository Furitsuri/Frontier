...
namespace Frontier.Combat
{
    ...
    public class Command
    {
        ...
        public static bool IsExecutableMoveCommand(Character character, StageController stageCtrl)
        {
            ...
            return !character.IsEndCommand(COMMAND_TAG.MOVE);
        }
        ...
        public static bool IsExecutableAttackCommand(Character character, StageController stageCtrl)
        {
            ...
            bool isExecutable = stageCtrl.RegistAttackAbleInfo(character.GetCurrentGridIndex(), character.param.attackRange, character.param.characterTag);
