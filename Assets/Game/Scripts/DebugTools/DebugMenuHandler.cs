...
public class DebugMenuHandler : BaseHandlerExtendedFocusRoutine
{
    ...
    private void RegisterInputCodes()
    {
        ...
        _inputFcd.RegisterInputCodes(
            (new GuideIcon[] { GuideIcon.VERTICAL_CURSOR }, "SELECT",   CanAcceptDirection, new AcceptDirectionInput(AcceptDirection),  MENU_DIRECTION_INPUT_INTERVAL, hashCode),
            (new GuideIcon[] { GuideIcon.CONFIRM },         "CONFIRM",  CanAcceptConfirm,   new AcceptBooleanInput(AcceptConfirm),      0.0f, hashCode),
            (new GuideIcon[] { GuideIcon.CANCEL },          "EXIT",     CanAcceptCancel,    new AcceptBooleanInput(AcceptCancel),       0.0f, hashCode)
        );
    }
    ...
    override public void Exit()
    {
        ...
        _inputFcd.RegisterInputCodes((new GuideIcon[] { Constants.GuideIcon.DEBUG_MENU }, "DEBUG", _canAcceptDebugTransitionCb, new AcceptBooleanInput(_acceptDebugTransitionCb), 0.0f, hashCode));
    }
