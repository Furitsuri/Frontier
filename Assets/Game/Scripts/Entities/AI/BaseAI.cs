...
namespace Frontier.Entities.Ai
{
    public abstract class BaseAi
    {
        ...
        virtual public (bool, bool) DetermineDestinationAndTarget( in BattleParameters battleParams, in Status status, in int[] ownerTileCosts, in CharacterKey charaKey ) { return (false, false); }
