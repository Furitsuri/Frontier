            ...
            switch (_Phase)
            {
                case PLMovePhase.PL_MOVE_SELECT_GRID:
                    ...
                    if (Input.GetKeyUp(KeyCode.Space))
                    {
                        ...
                        if (0 <= info.estimatedMoveRange)
                        {
                            ...
                            // 移動アニメーション開始
                            _selectPlayer.AnimCtrl.SetAnimator(AnimDatas.ANIME_CONDITIONS_TAG.MOVE, true);
                            // グリッド情報更新
                ...
                case PLMovePhase.PL_MOVE_EXECUTE:
                    ...
                    if (Vector3.Dot(dir, afterDir) < 0)
                    {
                        ...
                        {
                            _selectPlayer.AnimCtrl.SetAnimator(AnimDatas.ANIME_CONDITIONS_TAG.MOVE, false);
