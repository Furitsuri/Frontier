...
public class TutorialHandler : BaseHandlerExtendedFocusRoutine
{
    ...
    private void RegistInputCodes()
    {
        ...
        _inputFcd.RegisterInputCodes(
            (new GuideIcon[] { GuideIcon.HORIZONTAL_CURSOR },   "PAGE TRANSACTION", CanAcceptDirection, new AcceptDirectionInput(AcceptDirection),  MENU_DIRECTION_INPUT_INTERVAL, hashCode),
            (new GuideIcon[] { GuideIcon.CONFIRM },             "NEXT",             CanAcceptConfirm, new AcceptBooleanInput(AcceptConfirm), 0.0f, hashCode),
            (new GuideIcon[] { GuideIcon.CANCEL },              "BACK",             CanAcceptCancel, new AcceptBooleanInput(AcceptCancel), 0.0f, hashCode)
         );
    }
